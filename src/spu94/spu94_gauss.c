/* PS1 SPU Gaussian interpolation table.
 * 512 signed 16-bit entries dumped from SPU silicon by nocash.
 * Sources: psx-spx, DuckStation spu.cpp, Mednafen spu_fir_table.inc.
 * Three-way verified — all 512 entries match across all sources. */

#include <spu94/spu94_gauss.h>

const int16_t spu94_gauss_table[512] = {
    /* 0x000..0x00F */
