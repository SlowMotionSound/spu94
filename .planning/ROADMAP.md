...
- [x] 07-02-PLAN.md — scripts/regenerate_goldens.py + 50 committed .wav+.sha256 pairs + Dockerfile.repro (bookworm-slim digest-pinned) + new `reproducibility` CI job (TEST-04, TEST-08, BUILD-08)
