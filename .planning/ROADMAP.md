...
**Plans**: 2 plans
- [x] 61-01-PLAN.md — Wave-0 test scaffold: friend-seam headless test (8 cases pinning VCTRL-01/02/03, D-01, D-06), noteVelocity[24] seam, no-op apply stub (RED)
- [x] 61-02-PLAN.md — GREEN: applyContinuousVoiceControls() fan-out across [0,activeVoiceCount), per-note velocity capture, range reconciliation, sweep/duck ordering
**UI hint**: yes
...
**Success Criteria** (what must be TRUE):
  1. Saving a preset records the current active voice count (`.spu94` text presets only — binary DAW/session state deferred per Phase 63 decision D-02)
