...
- [x] **GUI-01**: A single rotary knob (250-300px diameter) is the sole control on the macro panel
- [x] **GUI-02**: 9 equally-spaced dot markers around the knob arc indicate exact preset waypoint positions
- [x] **GUI-03**: Turning the knob continuously updates the interpolated register values in real time (audio-rate or timer-driven)
